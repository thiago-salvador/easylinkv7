      ...
      <DialogContent className={cn(
        ...
        {hasTeamAccess ? (
          ...
          <div className="p-6"> {/* Adiciona padding interno */}
            <DialogHeader>
              <DialogTitle className="text-xl">Gerencie sua equipe</DialogTitle>
              <DialogDescription>Adicione ou remova membros da sua equipe.</DialogDescription>
            </DialogHeader>
            ...
            <div className="mt-6">
              ...
              <div className="space-y-2 mb-6">
                {members.map(member => (
                  <div key={member.id} className="flex items-center justify-between p-3 border rounded-md">
                    ...
                    {member.role !== 'owner' && (
                      <Button variant="ghost" size="icon" onClick={() => handleRemoveMember(member.id)} className="h-8 w-8">
              ...
              <form onSubmit={handleInvite} className="space-y-4">
                <div className="space-y-2">
                  <Label htmlFor="inviteEmail">Convidar novo membro</Label>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-0">
            ...
            <div className="md:col-span-1 p-5 bg-gradient-to-br from-blue-50/50 via-white to-indigo-50/30 flex flex-col space-y-4 relative z-10 rounded-l-lg overflow-hidden">
              ...
              <div className="absolute top-0 right-0 w-24 h-24 bg-gradient-to-br from-primary/10 to-blue-400/5 rounded-bl-full"></div>
              ...
              <div className="inline-flex items-center mb-1 px-3 py-1 bg-gradient-to-r from-blue-100 to-indigo-100 rounded-full">
                ...
                <span className="text-primary text-xs font-medium">Gerencie seu time</span>
              </div>
              
              <div>
                <h2 className="text-2xl font-bold bg-gradient-to-r from-gray-900 via-primary/90 to-indigo-800 text-transparent bg-clip-text">Plano Empresarial</h2>
              ...
              <div className="pt-2">
                <div className="mb-3 flex items-center justify-between bg-gradient-to-r from-blue-100/80 to-indigo-100/50 py-1.5 px-3 rounded-md">
                  <h3 className="font-semibold text-gray-800 text-sm">Recursos incluídos</h3>
                ...
                <div className="grid grid-cols-2 gap-2">
                  <div className="bg-white/80 border border-blue-100 rounded-lg p-2.5 flex flex-col items-center text-center">
                    ...
                    <span className="text-xs font-medium text-gray-800">Projetos ilimitados</span>
                  </div>
                  ...
                  <div className="bg-white/80 border border-blue-100 rounded-lg p-2.5 flex flex-col items-center text-center">
                    ...
                    <span className="text-xs font-medium text-gray-800">10 GB de armazenamento</span>
                  </div>
                  ...
                  <div className="bg-white/80 border border-blue-100 rounded-lg p-2.5 flex flex-col items-center text-center">
                    ...
                    <span className="text-xs font-medium text-gray-800">Membros ilimitados</span>
                  </div>
                  ...
                  <div className="bg-white/80 border border-blue-100 rounded-lg p-2.5 flex flex-col items-center text-center">
                    ...
                    <span className="text-xs font-medium text-gray-800">500k visitas/mês</span>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="md:col-span-1 p-5 bg-gradient-to-b from-white to-gray-50/30 flex flex-col space-y-4 relative z-10 rounded-r-lg overflow-hidden">
              ...
              <div className="flex items-center justify-between">
                <h2 className="text-xl font-bold text-gray-900">Faça upgrade</h2>
                ...
                <Tabs defaultValue="monthly" value={billingCycle} onValueChange={(value) => setBillingCycle(value as "monthly" | "yearly")} className="w-full">
                  <TabsList className="grid grid-cols-2 w-full p-1 h-10 bg-blue-50/70 rounded-lg mb-3">
                    ...
                    <TabsTrigger value="yearly" className="rounded-md flex items-center justify-center text-sm py-1 data-[state=active]:bg-white data-[state=active]:text-primary data-[state=active]:shadow-sm">
                      Anual <span className="text-xs text-green-600 ml-1 font-medium">(-{empresarialPlanDetails.yearlyDiscount})</span>
                    </TabsTrigger>
                  </TabsList>
                  
                  <div className="flex items-center justify-between px-2">
                    <div>
                      <div className="text-xs text-gray-500 mb-1">Total {billingCycle === "monthly" ? "mensal" : "anual"}</div>
                    ...
                    <div className="bg-green-50 border border-green-100 rounded-lg p-1.5 flex items-center">
                      ...
                      <span className="text-xs text-green-800">7 dias de garantia</span>
                    </div>
                  </div>
                </Tabs>
              </div>
              ...
              <div className="mt-1">
                ...
                <div className="flex items-center justify-center mt-3 mb-1">
                  ...
                  <span className="text-[11px] text-gray-500">Pagamento seguro via Stripe</span>
                </div>
              </div>
              ...
              <p className="text-[10px] text-gray-400 text-center">
                Ao continuar, você aceita nossos <Link href="/termos" className="text-gray-500 hover:text-primary">Termos</Link> e <Link href="/privacidade" className="text-gray-500 hover:text-primary">Privacidade</Link>                
              </p>
            </div>
          </div>
        )}
